 ...
 * Gomoku. Kelas ini merupakan pengembangan lebih lanjut dari kelas Board yang
 * ada di package Gomoku. Tujuannya adalah untuk memuat seluruh component yang
 * mendukung aktivitas online dengan koneksi internet.
 * 
...
public class Board {
	...
	private ListenerPlayOnline listener;
	...
	public Board(int rows, int cols, int wincount) {
		...
		listener = new ListenerPlayOnline(assets, status, wincount);
		...
		listener.getGiveup().addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				int result = JOptionPane.showConfirmDialog(null,
						(listener.getTurn() ? listener.getWhite().getName()
	 ...
	 * 
	 * @return ListenerPLayOnline yang digunakan pada kelas Board.
	 */
	public ListenerPlayOnline getListener() {
		return listener;
	}
